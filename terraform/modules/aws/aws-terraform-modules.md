...
12. Add the following output:
    ...
    - vpc-private-subnets
    - vpc-public-subnets
13. Click [code](https://github.com/sahilphule/templates/blob/master/terraform/modules/aws/vpc/outputs.tf) for reference.
...
4. Click [code](https://github.com/sahilphule/templates/blob/master/terraform/modules/aws/s3/main.tf) for reference.
5. We have completed defining *main.tf* file.
6. Now create *variables.tf* file.
7. Define the following variables:
    - s3-properties
8. Click [code](https://github.com/sahilphule/templates/blob/master/terraform/modules/aws/s3/variables.tf) for reference:
9. *variables.tf* file has been declared.
10. Now create *output.tf* file.
11. Inside *output.tf* file, define the following outputs:
    - s3-bucket-id
12. Click [code](https://github.com/sahilphule/templates/blob/master/terraform/modules/aws/s3/output.tf) for reference.
...
7. Define the following resources:
    ...
    - for bastion
        - aws_security_group
        - aws_key_pair
8. Click [code](https://github.com/sahilphule/templates/blob/master/terraform/modules/aws/rds/main.tf) for reference.
...
11. Inside *variables.tf* define the following variables:
    ...
    - database-properties
    - bastion-properties
12. Click [code](https://github.com/sahilphule/templates/blob/master/terraform/modules/aws/rds/variables.tf) for reference.
...
15. Inside the *outputs.tf* file, define the following output:
    - DB_HOST
    - bastion-host-ip
16. Click [code](https://github.com/sahilphule/templates/blob/master/terraform/modules/aws/rds/outputs.tf) for reference.
...
3. In the *main.tf* file, define the following resources:
    ...
    - aws_lb_target_group
    - aws_lb_listener
4. Click [code](https://github.com/sahilphule/templates/blob/master/terraform/modules/aws/load-balancer/main.tf) for reference.
...
9. Click [code](https://github.com/sahilphule/templates/blob/master/terraform/modules/aws/load-balancer/variables.tf) for reference.
...
14. Click [code](https://github.com/sahilphule/templates/blob/master/terraform/modules/aws/load-balancer/outputs.tf) for reference.
...
8. In the *main.tf* file, define the following resources:
    ...
    - for service
        - aws_security_group
        - aws_ecs_service
9. Click [code](https://github.com/sahilphule/templates/blob/master/terraform/modules/aws/ecs/main.tf) for reference.
...
13. Define the following variables:
    ...
    - load-balancer-tg-arn
    - load-balancer-sg-id
14. Click [code](https://github.com/sahilphule/templates/blob/master/terraform/modules/aws/ecs/variables.tf) for reference.
...
8. In the *main.tf* file, define the following resources:
    ...
    - for node
        ...
        - aws_iam_role_policy_attachment
        - aws_eks_node_group    
9. Click [code](https://github.com/sahilphule/templates/blob/master/terraform/modules/aws/eks/main.tf) for reference.
...
13. Define the following variables:
    ...
    - vpc-private-subnets
    - eks-properties
14. Click [code](https://github.com/sahilphule/templates/blob/master/terraform/modules/aws/eks/variables.tf) for reference.
